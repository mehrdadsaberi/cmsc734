...
function onColorChange() {
    ...
    var newColorScale =  d3.scaleSequential([min, max], d3.interpolateBlues);


    cellEnter.each(function(cell){
        cell.init(this);
        cell.update(this, cars, newColorScale, attr);
    });
...
d3.csv('./visualizations/events/cars.csv', dataPreprocessor).then(function(dataset) {
        ...
        cellEnter.each(function(cell){
            cell.init(this);
            cell.update(this, dataset, colorScale, "cylinders");
        });
